...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:trainingalfred.database.windows.net,1433;Initial Catalog=chinook;Persist Security Info=False;User ID=rwagajua;Password=Rwagie@sue18;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Workers>(entity =>
            {
                ...
                entity.HasOne(d => d.Dept)
                    ...
                    .HasConstraintName("FK__Workers__DeptID__6E01572D");
            });
